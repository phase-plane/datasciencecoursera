...
Link to my Statistical Inference repository: [My Repository](https://github.com/phase-plane/datasciencecoursera/tree/master/Inference)
...
First, we define some useful variables and a plotting library. 
```{r}
lambda <- .2
samples <- 40
simulations <- 1000
...
c) Use confidence intervals and/or hypothesis tests to compare tooth growth by supp and dose

d) State your conclusions and the assumptions needed for your conclusions